...
RSpec.describe 'Recipes', type: :request do
  before :all do
    ...
    @recipe = Recipe.create(name: 'Chicken Parmesan', preparation_time: 10, cooking_time: 30, description: 'This is a description', user: @taker)
    @recipe2 = Recipe.create(name: 'Chicken Parmesan', preparation_time: 10, cooking_time: 30, description: 'This is a description', user: @taker)
